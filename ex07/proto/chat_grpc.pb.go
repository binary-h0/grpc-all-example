...
func (c *chatServiceClient) ReceiveMessages(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func _ChatService_ReceiveMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).ReceiveMessages(m, &grpc.GenericServerStream[Empty, Message]{ServerStream: stream})
}
